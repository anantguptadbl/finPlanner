...
function getPPFData()
{
    currentAge=document.getElementById("PFCurrentAge").value;
    retiringAge=document.getElementById("PFRetiringAge").value;
    currentBalance=document.getElementById("PFCurrentBalance").value;
    monthlyDeposit=document.getElementById("PFMonthlyDeposit").value;
    $.post("/getPFData",
    {
      name: "Donald Duck",
      city: "Duckburg"
